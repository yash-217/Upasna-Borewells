...
export const Employees: React.FC<EmployeesProps> = ({ 
  employees, currentUser, onAddEmployee, onUpdateEmployee, onDeleteEmployee, vehicleFilter 
}) => {
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                   ...
                   <div>
                     ...
                     <input required type="number" className="w-full bg-white dark:bg-black border border-slate-200 dark:border-neutral-800 rounded-lg px-3 py-2 text-sm text-slate-900 dark:text-white"
